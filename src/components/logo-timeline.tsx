  ...
  return (
    <div aria-hidden="true" className="relative h-full overflow-hidden">
      <div className="absolute inset-0 top-8 z-10 flex items-center justify-center">
        ...
        />
        <div className="relative flex size-24 items-center justify-center rounded-xl bg-white shadow outline outline-offset-[-5px] outline-white/5 ring-1 ring-inset ring-white/10">
