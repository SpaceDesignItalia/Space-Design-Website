          ...
          {items.map((item) => (
            <li key={item.name}>
              <Link 
                ...
                href={item.href.startsWith('http') ? item.href : `/${language}${item.href}`} 
                size="sm"
    ...
    <footer className="flex w-full flex-col">
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        ...
        <div className="flex flex-wrap justify-between gap-2 pt-8">
          <p className="text-small text-default-400">&copy; {new Date().getFullYear()} Space Design Italia. All rights reserved.</p>
