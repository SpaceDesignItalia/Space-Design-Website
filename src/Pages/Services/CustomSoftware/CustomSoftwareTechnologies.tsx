...
export default function CustomSoftwareTechnologies() {
  const { t } = useLanguage();
  ...
  const technologies = [
    {
      ...
      description: "Backend scalabile e performante",
      category: "Backend",
    },
    {
      name: "React",
      icon: "logos:react",
      description: "Interfacce utente moderne",
      category: "Frontend",
    },
    {
      name: "Python",
      icon: "logos:python",
      description: "AI e automazione avanzata",
      category: "AI/ML",
    },
    {
      name: "PostgreSQL",
      icon: "logos:postgresql",
      description: "Database robusto e sicuro",
      category: "Database",
    },
    {
      name: "Docker",
      icon: "logos:docker-icon",
      description: "Deployment e scalabilità",
      category: "DevOps",
    },
    {
      name: "AWS",
