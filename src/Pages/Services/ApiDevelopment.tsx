              ...
              >
                ...
                >
                  ...
                  <span className="text-sm font-medium text-gray-600 dark:text-gray-400">
                    {t("api-development") || "Sviluppo API"}
                  </span>
                </motion.div>
                ...
                >
                  ...
                  >
                    {t("api-development-request-consultation") ||
                      "Richiedi Consulenza"}
                  </Button>
          ...
          <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
            ...
            >
              <h2 className="text-3xl font-bold tracking-tight text-white dark:text-black sm:text-4xl mb-6">
                {t("api-cta-title") || "Pronto a Costruire le Tue API?"}
              </h2>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                <Button
                  ...
                  endContent={<Icon icon="material-symbols:arrow-forward" />}
                >
                  {t("api-cta-button") || "Contattaci Ora"}
                </Button>
                ...
                <div className="flex items-center gap-4 text-white/80 dark:text-black/80">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm">
                      {t("faq-benefit-response") || "Risposta in 24h"}
                    </span>
                  </div>
                  <div className="flex items-center gap-2">
                    <Icon
