          ...
          <div>
            <div className="text-base/7 text-gray-300 lg:max-w-lg">
              <h1 className="mt-2 text-pretty text-4xl font-semibold tracking-tight text-white sm:text-5xl">
                {t("our-services-section-title")}
              </h1>
              <div className="max-w-xl">
                <p className="mt-6">{t("our-services-section-paragraph-1")}</p>
                <p className="mt-8">{t("our-services-section-paragraph-2")}</p>
            ...
            <dl className="mt-10 grid grid-cols-2 gap-8 border-t border-gray-700 pt-10">
              {stats.map((stat, statIdx) => (
                <div key={statIdx} className="text-center">
                  ...
                  <dd className="mt-2 text-3xl/10 font-bold tracking-tight text-white">
                    {stat.value}
                  </dd>
                </div>
              ))}
